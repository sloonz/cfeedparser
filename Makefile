# Automatically generated by scimake, don't edit.

_feedparser.so: feedparser.o
	gcc feedparser.o -o _feedparser.so -shared -lxml2 -lglib-2.0 

feedparser.o: feedparser.c /usr/include/glib-2.0/glib.h \
 ...
 /usr/include/libxml2/libxml/threads.h feedparser.h
	gcc -c feedparser.c -o feedparser.o -O4 -Wall  -I/usr/include/libxml2 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include
